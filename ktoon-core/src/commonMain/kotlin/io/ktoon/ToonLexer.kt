    ...
    fun peekToken(): Token? {
        ...
        return when {
            ...
            remaining[0] == '"' -> parseStringToken()
                ...
                "Unexpected character '${remaining[0]}' at line ${currentLineIndex + 1}, position $currentPosition"
            )
        }
    }
    ...
    fun parseString(): String {
        ...
        if (currentPosition >= line.length || line[currentPosition] != '"') {
            throw SerializationException(
                "Expected string literal at line ${currentLineIndex + 1}, position $currentPosition"
            )
        }
