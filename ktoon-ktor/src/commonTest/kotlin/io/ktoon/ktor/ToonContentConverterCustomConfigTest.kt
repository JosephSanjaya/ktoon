...
class ToonContentConverterCustomConfigTest {
    ...
    // Custom serializer for CustomTimestamp
    ...
    @Test
    fun testCustomToonInstanceCanBePassedToFunction() = runTest {
    ...
    fun testCustomInstanceIsUsedByConverter() = runTest {
        ...
        // Verify custom serializer was used (should contain "TS_" prefix)
    ...
    fun testCustomToonInstanceRoundTrip() = runTest {
        ...
        // First test direct Toon encoding to verify custom serializer works
        ...
        val content = (serialized as io.ktor.http.content.ByteArrayContent).bytes()
        val toonString = content.decodeToString()
        println("ContentConverter TOON output: $toonString")
    ...
    // Second custom type for multi-type test
    ...
    object CustomIdSerializer : KSerializer<CustomId> {
        ...
        override fun deserialize(decoder: Decoder): CustomId {
            ...
            // Parse format like "REC42" - extract prefix (letters) and number (digits)
